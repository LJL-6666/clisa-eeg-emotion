...
> 本版本维护至 2026-06-06；后续更新请访问 GitHub 仓库：<https://github.com/LJL-6666/clisa-eeg-emotion>。
...
- 跑 **CLISA**：进入 [`Clisa_analysis/`](Clisa_analysis/)，按其 README 操作（统一入口 `python scripts/run_reproduction_variant.py --list` 后选择 variant）。
